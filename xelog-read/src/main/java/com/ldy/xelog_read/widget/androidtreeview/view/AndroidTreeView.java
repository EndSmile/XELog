package com.ldy.xelog_read.widget.androidtreeview.view;
...
import com.ldy.xelog_read.widget.androidtreeview.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    public View getView(int style) {
        ...
        viewTreeItems.setId(R.id.xelog_read_tree_items);
        viewTreeItems.setOrientation(LinearLayout.VERTICAL);
        view.addView(viewTreeItems);

        mRoot.setViewHolder(new BaseNodeViewHolder(mContext) {
            @Override
    ...
    private void makeAllSelection(boolean selected, boolean skipCollapsed) {
        if (mSelectionModeEnabled) {
            for (TreeNode node : mRoot.getChildren()) {
                selectNodeAndChildren(node, selected, skipCollapsed);
            }
        }
    }
    ...
    public void selectNodeAndChildren(TreeNode parent, boolean selected, boolean skipCollapsed) {
